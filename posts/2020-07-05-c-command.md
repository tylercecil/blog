...
update:
note: "
  **Note**: This post requires some JS to render the syntax trees. I'm working
  on a tool to perfect this, but for now here is something rough and dirty.
  My apologies for any problems it might have --- it will be improved upon in
  the future
  "
...
[^xbar]: Why did I draw this tree as I did? There's a rich conversation about
  what the structure of these trees should be. What I've drawn here is
  something you might see in an intro to linguistics course, loosely based on
...
<div class="tree">
["Jeremy fooled himself into thinking..."
  [TP [NP [N [he]]] [T [clould]] [VP [V [love]] [NP [D [another]] [N [man]]]]]]
</div>
