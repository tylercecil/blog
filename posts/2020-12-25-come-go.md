...
update:
note: |
  **Note:** This post is an small adaptaion of a paper I wrote for the
...
And, I kid you not, the Inuit language Inuktitut has claim to fourteen
different spatial deictic terms [@denny1982]!
...
**P2:** While we were out shopping?1
:::
...
We can clean up a rules by adding this temporal constraint on things. I'll use
"$@ \text{time}$" to mean "true at a time". Gluing everything together gives
use these rules:
...
one would think for two works as "simple" as *come* and *go*!
...
* I said the speaker "takes the point of view of the listener" --- there is
  ...
  to use *come* and *go* differently than other children.
