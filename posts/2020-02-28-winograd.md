...
This is a very real pragmatic problem with the Imitation Game --- people don't
...
by Levesque @lev. I said this new test was going to revolve around a single
...
@levensque makes the claim that the Winograd schema test can be seen as a
...
program even qualified to compete (having failed a "easy" round 1).  @liu has a
very thorough report on their approach to the test, which scores 66.7%, a
state-of-the-art result. Remember, just "guessing" would yield 50%, so there's
plenty of work to be done.

I won't go into the methods being used, but you'll find some information in my
...
For example, in @lev-2, an unusual schema is presented:
